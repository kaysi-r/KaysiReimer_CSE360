	...
	public static String checkForValidemail(String input) {
		...
		while (running) {
			...
			case 0: 
				...
				// A-Z, a-z-> State 1
				// we will not accept the numbers for the first character
			...
			case 1: 
				...
				if (emailSize > 16 || countat > 1 || countperiod > 1)
					running = false;
				break;			
		...
		case 0:
			...
			//new error message
			emailRecognizerErrorMessage += "An email must start with A-Z or a-z.\n";
		...
		case 1:
			...
			if (emailSize < 6) {
				...
				emailRecognizerErrorMessage += "Input is too short. Please submit a valid email address\n";
				return emailRecognizerErrorMessage;
			}
			else if (emailSize > 16) {
				// UserName is too long
				emailRecognizerErrorMessage += 
					"An email must have no more than 16 character.\n";
				return emailRecognizerErrorMessage;
			}
			else if (currentCharNdx < input.length()) {
				// There are characters remaining in the input, so the input is not valid
				emailRecognizerErrorMessage += 
					"Invalid input1. Please submit a valid email address.\n";
				return emailRecognizerErrorMessage;
			}
			else if (afterat == 0) {
				emailRecognizerErrorMessage += "Invalid input2. Please submit a valid email address\\n";
				return emailRecognizerErrorMessage;
			}
			else if (afterperiod == 0) {
				emailRecognizerErrorMessage += "Invalid input3. Please submit a valid email address\\n";
				return emailRecognizerErrorMessage;
			}
			else {
					// email is valid
		...
		case 2:
			...
			emailRecognizerErrorMessage +=
				"An email character after a @ must be a-z. Please submit a valid email address\n";
			return emailRecognizerErrorMessage;
		case 3:
			emailRecognizerErrorMessage +=
				"An email character after a . must be a-z. Please submit a valid email address\\n";
